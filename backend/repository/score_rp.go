...
type ScoreRepository interface {
	Create(ctx context.Context, o model.Score) (*model.Score, error)
	GetById(ctx context.Context, id int) (*model.Score, error)
	GetAll(ctx context.Context, qId int) ([]model.Score, error)
	Update(ctx context.Context, o model.Score) (*model.Score, error)
...
func (r *scoreRepository) Create(ctx context.Context, s model.Score) (*model.Score, error) {
...
func (r *scoreRepository) Update(ctx context.Context, s model.Score) (*model.Score, error) {
	if err := r.db.WithContext(ctx).Updates(s).Error; err != nil {
		return nil, err
	}
	return &s, nil
}
